...
Nesse projeto construimos uma aplicação que aceita a entrada de um campo do usuário por um formulário e o redireciona para a página correta baseado em sua idade.

Na Aplicação foi utilizado **ExpressJS, Nunjucks, EditorConfig e ESLint**.
